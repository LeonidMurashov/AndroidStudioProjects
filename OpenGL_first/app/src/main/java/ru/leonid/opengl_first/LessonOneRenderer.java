package ru.leonid.opengl_first;
...
public class LessonOneRenderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height)
    {
        ...
        Matrix.rotateM(mProjectionMatrix, 0, 25, 1, 1, 1);
    }
    ...
    public void onDrawFrame(GL10 glUnused)
    {
        ...
        if(x<=2){x = (float) (x + 0.01);}
        else {x = (float)-1.5;}

        float waveOffset = new Random().nextInt()%40/(float)10000;
        // Draw the triangle facing straight on.
        Matrix.setIdentityM(mModelMatrix, 0);
        Matrix.translateM(mModelMatrix, 0, x, waveOffset, 0f);
        Matrix.rotateM(mModelMatrix, 0, new Random().nextInt()%10, 0f, 1.0f, 0);
        drawTriangle(mTriangle1Vertices);

        // Draw triangle_2.
        Matrix.setIdentityM(mModelMatrix, 0);
        Matrix.translateM(mModelMatrix, 0, x + 0.3f, waveOffset, 0.0f);
        ...
        Matrix.setIdentityM(mModelMatrix, 0);
        Matrix.translateM(mModelMatrix, 0, x, waveOffset, 0.0f);
        //Matrix.rotateM(mModelMatrix, 0, 0, 0.5f, 0.5f, 1.0f);
